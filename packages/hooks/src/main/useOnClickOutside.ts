// @reference from https://github.com/Andarist/use-onclickoutside/blob/main/src/index.ts
...
const useOnClickOutside = (
  ...
  useEffect(() => {
    ...
    const listener = (event: PossibleEvent) => {
      if (!ref.current || !handlerRef.current || ref.current.contains(event.target as Node)) return;
